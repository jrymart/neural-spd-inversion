...
def eval_neural_net_on_sine(seed, noise, data_type, label):
    ...
    if not os.path.exists(csv_path):
        ...
        trainer.evaluate()
        # denomalrize true labels in trainer.test_df
        trainer.test_df['true_labels'] = trainer.test_df['true_labels'] * label_stats['labels_std'] + label_stats['labels_mean']
