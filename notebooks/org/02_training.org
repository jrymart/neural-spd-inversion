#+title: Training
#+PROPERTY: header-args:python :python ../../.venv/bin/python :session traning
...
If this is being run in Colab, we want to copy over the data to the local Colab instance.
