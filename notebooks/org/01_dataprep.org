...
#+PROPERTY: header-args:jupyter-python :tangle ../../scripts/01_dataprep.py
...
#+end_src
  ...
  The model is initialized with random noise as elevation, an uplift rate, D8 flow router and accumulator and a diffusion and streampower erosion component with parameters defined by the study.  The parameters of this study are as follows:
+--------------+-----------------+------------------+-----------------+------------------+------------------------------+------------------------------------+-----------------------------------------+---------------+---------------+
...
This code was written by the Google Gemini LLM
#+begin_src jupyter-python
